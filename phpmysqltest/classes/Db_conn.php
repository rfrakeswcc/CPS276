...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'rfrakes';//this will be your WCC username
      $dbUsr = 'rfrakes';//this will be your WCC username
      $dbPass = 'wEJ3J8RoiZIjt4w';//this will be the password found in the video.
